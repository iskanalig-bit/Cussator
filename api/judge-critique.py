"""Vercel serverless function — POST /api/judge-critique (post-round Judge panel critique)."""
...
from _common import judge_critique  # noqa: E402
...
class handler(BaseHTTPRequestHandler):
    def do_POST(self):
        ...
        status, payload = judge_critique(body)
